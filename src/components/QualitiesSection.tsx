...
export default function QualitiesSection() {
  ...
  return (
    <section
      id="qualities"
      ref={sectionRef}
      className="Qualities relative flex w-full flex-col items-center gap-15 overflow-hidden bg-light md:h-dvh md:justify-between lg:h-auto lg:justify-normal lg:gap-30"
    >
