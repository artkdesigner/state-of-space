...
export default function CapacitySection() {
  return (
    ...
    >
      ...
      >
        <path
          className={`${ROTATE} animate-[spin-slow_110s_linear_infinite]`}
        ...
        />
        <path
          className={`${ROTATE} animate-[spin-slow-reverse_80s_linear_infinite]`}
        ...
        />
        <path
          className={`${ROTATE} animate-[spin-slow_95s_linear_infinite]`}
