...
export default function MoveVisual({ activeIndex, contentRef }: MoveVisualProps) {
  return (
    <>
      ...
      <div
        ref={contentRef}
        className="Move-content relative z-1 flex flex-col items-center gap-15 lg:gap-25"
      >
        <div className="Move-title-wrap flex w-full flex-col items-center gap-4 text-center lg:w-[117.5rem] lg:gap-10">
          ...
          <p className="Move-sub font-manrope text-[0.875rem] leading-[1.3] font-medium tracking-[-0.00875rem] text-dark/60 md:w-[25.875rem] lg:w-[40.25rem] lg:text-[1.125rem] lg:tracking-[-0.01125rem]">
            ...
            Light glides across the surface, and with it, the perception of
            time begins to shift. The yacht becomes a vantage point over
            infinity. And within that widening horizon, a new sense of freedom
            emerges.
          </p>
        </div>
