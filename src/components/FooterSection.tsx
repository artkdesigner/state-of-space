...
/** Должно совпадать с DWELL_VH в DriftSection.tsx — ровно на столько Drift
 * остаётся видна (уже приклеена), пока Footer наезжает на неё снизу через
