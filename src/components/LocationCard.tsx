...
export default function LocationCard({
  ...
  return (
    ...
    >
      <div className="Location-top flex min-h-95 w-75 max-w-75 min-w-75 flex-col items-center justify-center gap-10 overflow-hidden rounded-[7.5rem] bg-[rgba(33,31,30,0.3)] p-6 text-center backdrop-blur-[var(--location-blur,1.25rem)] md:min-h-120 md:w-90 md:max-w-90 md:min-w-90 md:rounded-[8.75rem] md:px-7.5 md:py-15 lg:min-h-137.5 lg:w-110 lg:max-w-110 lg:min-w-110 lg:rounded-[11.25rem] lg:px-15 lg:py-30">
      ...
      <div className="Location-footer flex w-full min-w-90 flex-col items-start gap-2.5 rounded-[2.5rem] bg-[rgba(33,31,30,0.3)] p-6 backdrop-blur-[var(--location-blur,1.25rem)] md:min-w-90 md:w-90 lg:min-w-110 lg:p-7.5">
